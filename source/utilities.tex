...
\tcode{regular}\iref{concepts.object} and
\tcode{three_way_comparable<strong_ordering>}\iref{cmp.concept}.
...
\pnum
The type models
\tcode{random_access_iterator}\iref{iterator.concept.random.access} and
meets the
